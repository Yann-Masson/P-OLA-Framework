...
namespace POLA::Training
{
  ...
  struct StateNorm
  {
    ...
    static constexpr double price_offset = 1500.0,
                            price_scale = 1500.0; // [1500, 3000] price units
  ...
  struct TrainingConfig
  {
    ...
    double entropyCoeff = 0.05;   ///< Entropy bonus to encourage exploration
    ...
    int episodeLength = 1440;
    ///< Max steps per episode (24 hours at 1 min/step)
    ///< Episodes mark PPO update boundaries only; room temperature drifts naturally
