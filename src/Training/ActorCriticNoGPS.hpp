 ...
 *
 * Identical architecture to ActorCritic, but exportActor() embeds the
...
struct ActorCriticNoGPSImpl : torch::nn::Module {
  /**
   ...
   */
  ActorCriticNoGPSImpl(int64_t stateDim = 40, int64_t actionDim = 1,
