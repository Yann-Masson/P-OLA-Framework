...
void AIRecorder::record(const double timestamp, const Common::AIState& state,
                        const double prediction, const double actualPower, const double reward)
{
    _records.push_back({
        timestamp, state.tempIn, state.electricityPrice,
